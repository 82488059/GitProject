...
namespace mfc{
    ...
    public:
        ...
        static HBITMAP CopyExeScreenToBitmap(CWnd* wnd, LPRECT lpRect) //lpRect 代表选定区域  
        {
            HDC hScrDC, hMemDC;
            // 屏幕和内存设备描述表  
            HBITMAP hBitmap, hOldBitmap;
...
//             hScrDC = CreateDCA("DISPLAY", NULL, NULL, NULL);
        ...
        static BOOL SaveBitmapToFile(HBITMAP hBitmap, LPSTR lpFileName) //hBitmap 为刚才的屏幕位图句柄  
        {      //lpFileName 为位图文件名  
            HDC     hDC;
            //设备描述表  
            int     iBits;
